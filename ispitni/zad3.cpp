...
class Demonstrator: public Student, public Predavach{
    int brCasovi;
public:
    Demonstrator(int indeks=0, int *ocenki=0, int brojOcenki=0, const char *imeIPrezime="", Kurs *kursevi=0, int brojKursevi=0, int brCasovi=0): Student(indeks,ocenki,brojOcenki), Predavach(imeIPrezime,kursevi,brojKursevi){
